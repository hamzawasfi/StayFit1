...
public class SignUp extends AppCompatActivity {
    ...
    private UsersInfoDataBase userInfoDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userInfoDB = new UsersInfoDataBase(this);
    }
    ...
    public boolean checkInputs() {
        ...
        if (ageInput == 0 || weightInput == 0 || heightInput == 0 || sexInput == 0 || goalInput == 0) {
            ...
            int sexInt = 0;
            if(sexInput == R.id.malebtn){
                sexInt = 1;
            }else if (sexInput == R.id.femalebtn){
                sexInt = 2;
            }

            int goalInt = 0;
            if(goalInput == R.id.lossbtn){
                goalInt = 1;
            }else if (goalInput == R.id.maintainbtn){
                goalInt = 2;
            }else if (goalInput == R.id.gainbtn){
                goalInt = 3;
            }
